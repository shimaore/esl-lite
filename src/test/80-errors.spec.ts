...
it('should detect invalid (late) syntax', { timeout: 5 * second }, async function (t) {
  const id = uuidv4()
  const options = {
    tracer_uuid: id,
  }
...
it('should detect invalid destination', { timeout: 2200 }, async function (t) {
  const client = new FreeSwitchClient({
    port: clientPort,
    logger: logger(),
  })
...
void it('should detect late progress', { timeout: 10000 }, async function (t) {
  const client = new FreeSwitchClient({
    port: clientPort,
    logger: logger(),
  })
...
const shouldDetect = function (code: string, pattern: RegExp) {
  return async function (t:TestContext) {
    ...
    service.on('CHANNEL_CREATE', function (msg) {
      assert('variable_tracer_uuid' in msg.body.data && msg.body.data['variable_tracer_uuid'] === id)
    })
    ...
    service.once('CHANNEL_HANGUP', function (msg) {
      assert('variable_tracer_uuid' in msg.body.data && msg.body.data['variable_tracer_uuid'] === id &&
           'variable_sip_term_status' in msg.body.data && msg.body.data['variable_sip_term_status'] === code)
    })
    service.on('CHANNEL_HANGUP_COMPLETE', function (msg) {
      assert('variable_tracer_uuid' in msg.body.data && msg.body.data['variable_tracer_uuid'] === id &&
           'variable_sip_term_status' in msg.body.data && msg.body.data['variable_sip_term_status'] === code &&
           'variable_billmsec' in msg.body.data && msg.body.data['variable_billmsec'] === '0')
    })
...
void it('should detect 403', { timeout: 1000 }, shouldDetect('403', /^-ERR CALL_REJECTED/))
void it( 'should detect 404', { timeout: 1000 }, shouldDetect('404', /^-ERR UNALLOCATED_NUMBER/))
...
void it( 'should detect 408', { timeout: 1000 }, shouldDetect('408', /^-ERR RECOVERY_ON_TIMER_EXPIRE/))
void it('should detect 410', { timeout: 1000 }, shouldDetect('410', /^-ERR NUMBER_CHANGED/))
void it( 'should detect 415', { timeout: 1000 }, shouldDetect('415', /^-ERR SERVICE_NOT_IMPLEMENTED/))
void it( 'should detect 450', { timeout: 1000 }, shouldDetect('450', /^-ERR NORMAL_UNSPECIFIED/))
void it( 'should detect 455', { timeout: 1000 }, shouldDetect('455', /^-ERR NORMAL_UNSPECIFIED/))
void it('should detect 480', { timeout: 1000 }, shouldDetect('480', /^-ERR NO_USER_RESPONSE/))
void it( 'should detect 481', { timeout: 1000 }, shouldDetect('481', /^-ERR NORMAL_TEMPORARY_FAILURE/))
void it( 'should detect 484', { timeout: 1000 }, shouldDetect('484', /^-ERR INVALID_NUMBER_FORMAT/))
void it( 'should detect 485', { timeout: 1000 }, shouldDetect('485', /^-ERR NO_ROUTE_DESTINATION/))
void it('should detect 486', { timeout: 1000 }, shouldDetect('486', /^-ERR USER_BUSY/))
void it('should detect 487', { timeout: 1000 }, shouldDetect('487', /^-ERR ORIGINATOR_CANCEL/))
void it( 'should detect 488', { timeout: 1000 }, shouldDetect('488', /^-ERR INCOMPATIBLE_DESTINATION/))
void it( 'should detect 491', { timeout: 1000 }, shouldDetect('491', /^-ERR NORMAL_UNSPECIFIED/))
void it( 'should detect 500', { timeout: 1000 }, shouldDetect('500', /^-ERR NORMAL_TEMPORARY_FAILURE/))
void it( 'should detect 502', { timeout: 1000 }, shouldDetect('502', /^-ERR NETWORK_OUT_OF_ORDER/))
void it( 'should detect 503', { timeout: 1000 }, shouldDetect('503', /^-ERR NORMAL_TEMPORARY_FAILURE/))
void it( 'should detect 504', { timeout: 1000 }, shouldDetect('504', /^-ERR RECOVERY_ON_TIMER_EXPIRE/))
void it('should detect 600', { timeout: 1000 }, shouldDetect('600', /^-ERR USER_BUSY/))
void it('should detect 603', { timeout: 1000 }, shouldDetect('603', /^-ERR CALL_REJECTED/))
void it( 'should detect 604', { timeout: 1000 }, shouldDetect('604', /^-ERR NO_ROUTE_DESTINATION/))
void it( 'should detect 606', { timeout: 1000 }, shouldDetect('606', /^-ERR INCOMPATIBLE_DESTINATION/))
